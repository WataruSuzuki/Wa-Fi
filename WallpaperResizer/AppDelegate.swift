...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey : Any]? = nil) -> Bool {
        ...
        //let appCOption : UInt = UInt((APPC_CLOUD_AD | APPC_CLOUD_PUSH))
        //appCCloud.setupAppCWithMediaKey("6720ad39e82000a7a60049b10e7c9dc8008a7443", option: appCOption, launchOptions: launchOptions)
...
//        self.saveContext()
    ...
    func application(_ application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: Data) {
        //appCCloud.pushNotificationDidRegisterWithDeviceToken(deviceToken)
    }
...
//        // The directory the application uses to store the Core Data store file. This code uses a directory named "jp.co.JchanKchan.WallpaperResizer" in the application's documents Application Support directory.
...
//        let modelURL = Bundle.main.url(forResource: "WallpaperResizer", withExtension: "momd")
...
//        do {
//            let url = self.applicationDocumentsDirectory.appendingPathComponent("WallpaperResizer.sqlite")
